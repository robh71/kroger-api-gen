...
class CartApi(object):
    ...
    def put_carts(self, **kwargs):  # noqa: E501
        """Add to cart  # noqa: E501

        Provides access to add items to an authenticated customer's cart.  <br><br> **Note**: the customer must be authenticated using the OAuth2 Authorization Code grant type.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_carts(async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param CartCartItemRequestModel body: A list of items that you are adding to the cart.
        :return: APIErrorCartOk
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.put_carts_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.put_carts_with_http_info(**kwargs)  # noqa: E501
            return data

    def put_carts_with_http_info(self, **kwargs):  # noqa: E501
        """Add to cart  # noqa: E501

        Provides access to add items to an authenticated customer's cart.  <br><br> **Note**: the customer must be authenticated using the OAuth2 Authorization Code grant type.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.put_carts_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        return self.api_client.call_api(
            ...
            response_type='APIErrorCartOk',  # noqa: E501
