...
class APIErrorAuthServerError(object):
    ...
    """
    swagger_types = {
        'errors': 'APIErrorAuthServerErrorErrors'
    }
    ...
    def __init__(self, errors=None):  # noqa: E501
        """APIErrorAuthServerError - a model defined in Swagger"""  # noqa: E501
        self._errors = None
    ...
    @property
    def errors(self):
        """Gets the errors of this APIErrorAuthServerError.  # noqa: E501


        :return: The errors of this APIErrorAuthServerError.  # noqa: E501
        :rtype: APIErrorAuthServerErrorErrors
        """
        return self._errors

    @errors.setter
    def errors(self, errors):
        """Sets the errors of this APIErrorAuthServerError.


        :param errors: The errors of this APIErrorAuthServerError.  # noqa: E501
        :type: APIErrorAuthServerErrorErrors
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(APIErrorAuthServerError, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, APIErrorAuthServerError):
            return False
