...
class APIErrorCartServerError(object):
    ...
    """
    swagger_types = {
        'errors': 'APIErrorCartServerErrorErrors'
    }
    ...
    def __init__(self, errors=None):  # noqa: E501
        """APIErrorCartServerError - a model defined in Swagger"""  # noqa: E501
        self._errors = None
    ...
    @property
    def errors(self):
        """Gets the errors of this APIErrorCartServerError.  # noqa: E501


        :return: The errors of this APIErrorCartServerError.  # noqa: E501
        :rtype: APIErrorCartServerErrorErrors
        """
        return self._errors

    @errors.setter
    def errors(self, errors):
        """Sets the errors of this APIErrorCartServerError.


        :param errors: The errors of this APIErrorCartServerError.  # noqa: E501
        :type: APIErrorCartServerErrorErrors
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(APIErrorCartServerError, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, APIErrorCartServerError):
            return False
