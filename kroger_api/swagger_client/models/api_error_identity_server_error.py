...
class APIErrorIdentityServerError(object):
    ...
    """
    swagger_types = {
        'errors': 'APIErrorIdentityServerErrorErrors'
    }
    ...
    def __init__(self, errors=None):  # noqa: E501
        """APIErrorIdentityServerError - a model defined in Swagger"""  # noqa: E501
        self._errors = None
    ...
    @property
    def errors(self):
        """Gets the errors of this APIErrorIdentityServerError.  # noqa: E501


        :return: The errors of this APIErrorIdentityServerError.  # noqa: E501
        :rtype: APIErrorIdentityServerErrorErrors
        """
        return self._errors

    @errors.setter
    def errors(self, errors):
        """Sets the errors of this APIErrorIdentityServerError.


        :param errors: The errors of this APIErrorIdentityServerError.  # noqa: E501
        :type: APIErrorIdentityServerErrorErrors
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(APIErrorIdentityServerError, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, APIErrorIdentityServerError):
            return False
