...
class APIErrorProductsServerError(object):
    ...
    """
    swagger_types = {
        'errors': 'APIErrorProductsServerErrorErrors'
    }
    ...
    def __init__(self, errors=None):  # noqa: E501
        """APIErrorProductsServerError - a model defined in Swagger"""  # noqa: E501
        self._errors = None
    ...
    @property
    def errors(self):
        """Gets the errors of this APIErrorProductsServerError.  # noqa: E501


        :return: The errors of this APIErrorProductsServerError.  # noqa: E501
        :rtype: APIErrorProductsServerErrorErrors
        """
        return self._errors

    @errors.setter
    def errors(self, errors):
        """Sets the errors of this APIErrorProductsServerError.


        :param errors: The errors of this APIErrorProductsServerError.  # noqa: E501
        :type: APIErrorProductsServerErrorErrors
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(APIErrorProductsServerError, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, APIErrorProductsServerError):
            return False
