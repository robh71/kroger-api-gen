...
class CartCartItemModel(object):
    ...
    def __init__(self, quantity=None, upc=None):  # noqa: E501
        """CartCartItemModel - a model defined in Swagger"""  # noqa: E501
        self._quantity = None
        self._upc = None
    ...
    @property
    def quantity(self):
        """Gets the quantity of this CartCartItemModel.  # noqa: E501

        The quantity of the item.  # noqa: E501

        :return: The quantity of this CartCartItemModel.  # noqa: E501
        :rtype: int
        """
    ...
    def quantity(self, quantity):
        """Sets the quantity of this CartCartItemModel.

        The quantity of the item.  # noqa: E501

        :param quantity: The quantity of this CartCartItemModel.  # noqa: E501
        :type: int
        """
        if quantity is None:
    ...
    @property
    def upc(self):
        """Gets the upc of this CartCartItemModel.  # noqa: E501

        The `UPC` of the item.  # noqa: E501

        :return: The upc of this CartCartItemModel.  # noqa: E501
        :rtype: str
        """
        return self._upc
    ...
    @upc.setter
    def upc(self, upc):
        """Sets the upc of this CartCartItemModel.

        The `UPC` of the item.  # noqa: E501

        :param upc: The upc of this CartCartItemModel.  # noqa: E501
        :type: str
        """
        if upc is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CartCartItemModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CartCartItemModel):
            return False
