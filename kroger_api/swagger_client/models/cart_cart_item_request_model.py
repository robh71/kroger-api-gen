...
class CartCartItemRequestModel(object):
    ...
    def __init__(self, items=None):  # noqa: E501
        """CartCartItemRequestModel - a model defined in Swagger"""  # noqa: E501
        self._items = None
    ...
    @property
    def items(self):
        """Gets the items of this CartCartItemRequestModel.  # noqa: E501

        An array of items in the cart.  # noqa: E501

        :return: The items of this CartCartItemRequestModel.  # noqa: E501
        :rtype: list[CartCartItemModel]
        """
        return self._items

    @items.setter
    def items(self, items):
        """Sets the items of this CartCartItemRequestModel.

        An array of items in the cart.  # noqa: E501

        :param items: The items of this CartCartItemRequestModel.  # noqa: E501
        :type: list[CartCartItemModel]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CartCartItemRequestModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CartCartItemRequestModel):
            return False
