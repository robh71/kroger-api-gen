...
class LocationsChain(object):
    ...
    attribute_map = {
        'name': 'name',
        'division_numbers': 'divisionNumbers'
    }

    def __init__(self, name=None, division_numbers=None):  # noqa: E501
        """LocationsChain - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._division_numbers = None
        self.discriminator = None
        if name is not None:
            self.name = name
        if division_numbers is not None:
            self.division_numbers = division_numbers

    @property
    def name(self):
        """Gets the name of this LocationsChain.  # noqa: E501

        The name of the chain.  # noqa: E501

        :return: The name of this LocationsChain.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LocationsChain.

        The name of the chain.  # noqa: E501

        :param name: The name of this LocationsChain.  # noqa: E501
        :type: str
        """
    ...
    def division_numbers(self):
        """Gets the division_numbers of this LocationsChain.  # noqa: E501

        A list of all management division numbers within this brand.  # noqa: E501

        :return: The division_numbers of this LocationsChain.  # noqa: E501
        :rtype: list[str]
        """
        return self._division_numbers

    @division_numbers.setter
    def division_numbers(self, division_numbers):
        """Sets the division_numbers of this LocationsChain.

        A list of all management division numbers within this brand.  # noqa: E501

        :param division_numbers: The division_numbers of this LocationsChain.  # noqa: E501
        :type: list[str]
        """

        self._division_numbers = division_numbers
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocationsChain, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocationsChain):
            return False
