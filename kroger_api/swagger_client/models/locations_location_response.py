...
class LocationsLocationResponse(object):
    ...
    def __init__(self, data=None, meta=None):  # noqa: E501
        """LocationsLocationResponse - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._meta = None
    ...
    @property
    def data(self):
        """Gets the data of this LocationsLocationResponse.  # noqa: E501


        :return: The data of this LocationsLocationResponse.  # noqa: E501
        :rtype: LocationsLocation
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this LocationsLocationResponse.


        :param data: The data of this LocationsLocationResponse.  # noqa: E501
    ...
    @property
    def meta(self):
        """Gets the meta of this LocationsLocationResponse.  # noqa: E501


        :return: The meta of this LocationsLocationResponse.  # noqa: E501
        :rtype: MetaModel
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this LocationsLocationResponse.


        :param meta: The meta of this LocationsLocationResponse.  # noqa: E501
        :type: MetaModel
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocationsLocationResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocationsLocationResponse):
            return False
