...
class Oauth2CodeResponse(object):
    ...
    def __init__(self):  # noqa: E501
        """Oauth2CodeResponse - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(Oauth2CodeResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Oauth2CodeResponse):
            return False
