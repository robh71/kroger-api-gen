...
class ProductsProductImageSizeModel(object):
    ...
    def __init__(self, id=None, size=None, url=None):  # noqa: E501
        """ProductsProductImageSizeModel - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._size = None
        self._url = None
    ...
    @property
    def id(self):
        """Gets the id of this ProductsProductImageSizeModel.  # noqa: E501

        An optional identifier of the image size.  # noqa: E501

        :return: The id of this ProductsProductImageSizeModel.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ProductsProductImageSizeModel.

        An optional identifier of the image size.  # noqa: E501

        :param id: The id of this ProductsProductImageSizeModel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def size(self):
        """Gets the size of this ProductsProductImageSizeModel.  # noqa: E501

        A description of the image size.  # noqa: E501

        :return: The size of this ProductsProductImageSizeModel.  # noqa: E501
        :rtype: str
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this ProductsProductImageSizeModel.

        A description of the image size.  # noqa: E501

        :param size: The size of this ProductsProductImageSizeModel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def url(self):
        """Gets the url of this ProductsProductImageSizeModel.  # noqa: E501

        The URL location of the image.  # noqa: E501

        :return: The url of this ProductsProductImageSizeModel.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this ProductsProductImageSizeModel.

        The URL location of the image.  # noqa: E501

        :param url: The url of this ProductsProductImageSizeModel.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProductsProductImageSizeModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductsProductImageSizeModel):
            return False
