...
class ProductsProductTemperatureModel(object):
    ...
    attribute_map = {
        'indicator': 'indicator',
        'heat_sensitive': 'heatSensitive'
    }

    def __init__(self, indicator=None, heat_sensitive=None):  # noqa: E501
        """ProductsProductTemperatureModel - a model defined in Swagger"""  # noqa: E501
        self._indicator = None
        self._heat_sensitive = None
        self.discriminator = None
        if indicator is not None:
            self.indicator = indicator
        if heat_sensitive is not None:
            self.heat_sensitive = heat_sensitive

    @property
    def indicator(self):
        """Gets the indicator of this ProductsProductTemperatureModel.  # noqa: E501

        Information about the product's storage temperature.  # noqa: E501

        :return: The indicator of this ProductsProductTemperatureModel.  # noqa: E501
        :rtype: str
        """
    ...
    def indicator(self, indicator):
        """Sets the indicator of this ProductsProductTemperatureModel.

        Information about the product's storage temperature.  # noqa: E501

        :param indicator: The indicator of this ProductsProductTemperatureModel.  # noqa: E501
        :type: str
        """
    ...
    @property
    def heat_sensitive(self):
        """Gets the heat_sensitive of this ProductsProductTemperatureModel.  # noqa: E501

        Indicates if the item is heat sensitive.  # noqa: E501

        :return: The heat_sensitive of this ProductsProductTemperatureModel.  # noqa: E501
        :rtype: bool
        """
        return self._heat_sensitive

    @heat_sensitive.setter
    def heat_sensitive(self, heat_sensitive):
        """Sets the heat_sensitive of this ProductsProductTemperatureModel.

        Indicates if the item is heat sensitive.  # noqa: E501

        :param heat_sensitive: The heat_sensitive of this ProductsProductTemperatureModel.  # noqa: E501
        :type: bool
        """

        self._heat_sensitive = heat_sensitive
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProductsProductTemperatureModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductsProductTemperatureModel):
            return False
