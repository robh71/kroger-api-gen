...
class ProductsProductsPayloadModel(object):
    ...
    """
    swagger_types = {
        'data': 'list[ProductsProductModel]',
        'meta': 'MetaModel'
    }
    ...
    def __init__(self, data=None, meta=None):  # noqa: E501
        """ProductsProductsPayloadModel - a model defined in Swagger"""  # noqa: E501
        self._data = None
        self._meta = None
    ...
    @property
    def data(self):
        """Gets the data of this ProductsProductsPayloadModel.  # noqa: E501


        :return: The data of this ProductsProductsPayloadModel.  # noqa: E501
        :rtype: list[ProductsProductModel]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ProductsProductsPayloadModel.


        :param data: The data of this ProductsProductsPayloadModel.  # noqa: E501
        :type: list[ProductsProductModel]
        """
    ...
    @property
    def meta(self):
        """Gets the meta of this ProductsProductsPayloadModel.  # noqa: E501


        :return: The meta of this ProductsProductsPayloadModel.  # noqa: E501
        :rtype: MetaModel
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ProductsProductsPayloadModel.


        :param meta: The meta of this ProductsProductsPayloadModel.  # noqa: E501
        :type: MetaModel
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProductsProductsPayloadModel, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductsProductsPayloadModel):
            return False
